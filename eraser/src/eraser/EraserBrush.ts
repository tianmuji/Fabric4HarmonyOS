...
export type ErasingEvent<T extends ErasingEventType> = EventDetailMap[T]
...
export class EraserBrush extends fabric.PencilBrush {
  ...
  private _allPoints: fabric.Point[][]
  ...
  drawEffect() {
    const lowerCtx = this.canvas.getContext()
  ...
  //   // this.canvas.getContext().globalCompositeOperation = 'destination-out'
  //   super._render(this.canvas.getTopContext());
  ...
  //   // this._disposer?.();
  //   lowerCtx.globalCompositeOperation = 'destination-out'
  //   lowerCtx.resetTransform()
  //   delete this._disposer;
  //   this._allPoints.push(this['_points'])
  //   this._allPoints.forEach(points => {
  //     const pathObj = new fabric.Polyline(points, {
  //       width: this.width,
  //       color: this.color
  //     })
  ...
  //   lowerCtx.globalCompositeOperation = 'source-over'
  //   // this.drawEffect();
  //   // const upperContext = this.canvas.getTopContext()
  //   // upperContext.clearRect(0, 0, upperContext.width, upperContext.height)
  //   return false;
  // }
