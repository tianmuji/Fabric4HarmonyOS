...
import type { Group, GroupEvents, GroupProps, SerializedGroupProps } from './shapes/Group';
...
// arkts dose not support dynamic
export class Collection extends CommonMethods<CanvasEvents> {
  /**
   * @type {FabricObject[]}
   * @TODO needs to end up in the constructor too
   */
...
export class GroupCollection extends FabricObject<GroupProps, SerializedGroupProps, GroupEvents> {
  /**
   * @type {FabricObject[]}
   * @TODO needs to end up in the constructor too
   */
